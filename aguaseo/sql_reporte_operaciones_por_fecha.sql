...
and (vert.fecha_registro at time zone 'UTC-5')::date between '2018-09-01' and '2018-09-30'
group by vert.code
,vert.container_id
-- ,to_char(vert.fecha_registro at time zone 'UTC-5','YYYY-MM-DD')
order by vert.code asc--,to_char(vert.fecha_registro at time zone 'UTC-5','YYYY-MM-DD')